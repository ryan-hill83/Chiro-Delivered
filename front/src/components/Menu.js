...
class Menu extends Component {
  ...
  <Link className="navbar-brand" to="/"><img src={require('./images/logo_medium.jpg')} className="d-inline-block align-top navlogo" alt=""></img></Link> &nbsp; &nbsp; <p className="contact-info navbar-nav ml-auto flex-nowrap">(630)687-2934test</p>
